...
aibom-monorepo contains the source, package configuration, and release tooling for `aibom-monorepo`.

## Repository Structure

- `packages/aibom` - package source and package-specific documentation.
- `packages/webapp` - package source and package-specific documentation.
